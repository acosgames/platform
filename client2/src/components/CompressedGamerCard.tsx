                    ...
                    <div className="flex items-start justify-between gap-2">
                        <div className="min-w-0">
                            ...
                            <div className="mt-1 flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wide text-slate-800">
                                <img src={flagSrc} alt={`${countrycode} flag`} className="h-[16px] w-[23px] rounded-[2px] border border-slate-700 object-cover" title={countrycode} />
                        ...
                        <div ref={menuRef} className="relative top-1 right-0 z-10" onBlur={handleMenuBlur}>
                            <button
                                ...
                                className="flex h-6 w-6 items-center justify-center rounded-md text-slate-700 hover:bg-slate-800 hover:text-slate-900 focus:outline-none"
                                aria-label="Menu"
                            >
