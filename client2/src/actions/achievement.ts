import { btAchievementAward, btClaimingAchievement, btGame, btUser } from "./buckets";
import { POST } from "./http";

export async function claimAchievement(game_slug: string, achievement_slug: string) {
    try {
